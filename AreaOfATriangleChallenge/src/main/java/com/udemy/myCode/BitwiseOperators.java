...
public class BitwiseOperators {
    /*
     * - Bitwise operators: Bitwise operators work on the individual bits (binary
     * representation) of integer values.
     * - The AND operation compares each bit position. Only when both bits are 1
     * does the result have a 1 in that position.
     */
    ...
    public static void BitwiseExample2() {
        ...
        /*
         * # This is a bit-packing technique - storing two 4-bit values in a single
         * 8-bit byte to save memory.
         */
    }
